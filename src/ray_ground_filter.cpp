 ...
 *  v1.1: masaya kataoka (ms.kataoka@gmail.com)
 */
#include <algorithm>
#include <iostream>
...
#include <rosbagraph_slam/ray_ground_filter.h>

/*
void RayGroundFilter::update_config_params(const
autoware_config_msgs::ConfigRayGroundFilter::ConstPtr& param)
{
 ...
 * the other removed as indicated
 * in the indices
